...
```php
<a href="{{ '/' | relative_url }}" title="jacobworsoe.dk" rel="home" class="blog-title">
...
Det gamle design havde en pagespeed score på 86 for desktop. <a href="https://developers.google.com/speed/pagespeed/insights/?url={{ '/' | absolute_url | uri_escape }}&tab=desktop" rel="noopener noreferrer" target="_blank">Den er nu 99</a>.
...
Den vigtige metric er dog mobile nu og <a href="https://developers.google.com/speed/pagespeed/insights/?url={{ '/' | absolute_url | uri_escape }}&tab=mobile" rel="noopener noreferrer" target="_blank">den er 96</a>.
