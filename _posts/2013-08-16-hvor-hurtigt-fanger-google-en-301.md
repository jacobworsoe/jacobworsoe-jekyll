...
<figure><a href="{{ '/assets/images/redirect-start1.png' | relative_url }}"><img class="size-medium wp-image-98 " alt="Da jeg opsatte 301'eren indeholdte sitet 349 url'er." src="{{ '/assets/images/redirect-start1-640x103.png' | relative_url }}" width="640" height="103" /></a><figcaption>Da jeg opsatte 301'eren indeholdte sitet 349 url'er.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/chart.png' | relative_url }}"><img class="size-full wp-image-100" alt="Udvikling i sider i indeks" src="{{ '/assets/images/chart.png' | relative_url }}" width="640" height="273" /></a><figcaption>Udvikling i sider i indeks</figcaption></figure>
