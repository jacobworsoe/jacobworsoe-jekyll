...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-23.01.11.png' | relative_url }}"><img class="size-medium wp-image-527" alt="Priser for Convert Experiments" src="{{ '/assets/images/Screenshot-2014-02-20-23.01.11-750x417.png' | relative_url }}" width="750" height="417" /></a><figcaption>Priser for Convert Experiments</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-19.46.27.png' | relative_url }}"><img class="size-medium wp-image-528" alt="Sammenkobling af Wordpress og Convert Experiments." src="{{ '/assets/images/Screenshot-2014-02-20-19.46.27-750x308.png' | relative_url }}" width="750" height="308" /></a><figcaption>Sammenkobling af Wordpress og Convert Experiments.</figcaption></figure>

Derefter hopper man over i et lækkert interface og opretter et eksperiment.

<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-19.36.52.png' | relative_url }}"><img class="size-medium wp-image-529" alt="Convert Experiment's webinterface." src="{{ '/assets/images/Screenshot-2014-02-20-19.36.52-750x371.png' | relative_url }}" width="750" height="371" /></a><figcaption>Convert Experiment's webinterface.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-20.14.34.png' | relative_url }}"><img class="size-medium wp-image-530" alt="Navngivning og valg af eksperiment type." src="{{ '/assets/images/Screenshot-2014-02-20-20.14.34-750x525.png' | relative_url }}" width="750" height="525" /></a><figcaption>Navngivning og valg af eksperiment type.</figcaption></figure>

Man bliver derefter sendt til den visuelle designer, hvor man kan foretage ændringer på den side man gerne vil teste.

<figure><a href="{{ '/assets/images/Screenshot-2014-02-21-00.07.05.png' | relative_url }}"><img class="size-medium wp-image-532" alt="Visuel designer." src="{{ '/assets/images/Screenshot-2014-02-21-00.07.05-750x372.png' | relative_url }}" width="750" height="372" /></a><figcaption>Visuel designer.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-20.15.20.png' | relative_url }}"><img class="size-full wp-image-533" alt="Ændring af knappens farve." src="{{ '/assets/images/Screenshot-2014-02-20-20.15.20.png' | relative_url }}" width="417" height="433" /></a><figcaption>Ændring af knappens farve.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-21-00.11.33.png' | relative_url }}"><img class="size-full wp-image-534" alt="Valg af mål." src="{{ '/assets/images/Screenshot-2014-02-21-00.11.33.png' | relative_url }}" width="515" height="419" /></a><figcaption>Valg af mål.</figcaption></figure>
...
Bemærk at de har valgt et lidt utraditionelt signifikansniveau for deres tests som standard på 97%, som alt andet lige kræver mere data/tid, for at kunne træffe konklusioner. Jeg vil dog anbefale at skrue det ned til 95% signifikans, som giver et bedre mix mellem den tid det tager at køre testen og den sikkerhed du har for at træffe korrekte beslutninger. Hvis alt dette er sort snak, så vil jeg anbefale dig denne artikler, hvor jeg gennemgår alle disse begreber: <a href="{{ '/statistikken-bag-google-website-optimizer/' | relative_url }}" target="_blank" rel="noopener">Statistikken bag en splittest</a>.

<figure><a href="{{ '/assets/images/Screenshot-2014-02-21-00.21.58.png' | relative_url }}"><img class="size-medium wp-image-535" alt="Smart opsummering af indstillingerne for testen." src="{{ '/assets/images/Screenshot-2014-02-21-00.21.58-750x319.png' | relative_url }}" width="750" height="319" /></a><figcaption>Smart opsummering af indstillingerne for testen.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/faktorfobi-checkout.png' | relative_url }}"><img class="size-medium wp-image-550" alt="Betalingsflowet på faktorfobi." src="{{ '/assets/images/faktorfobi-checkout-750x449.png' | relative_url }}" width="750" height="449" /></a><figcaption>Betalingsflowet på faktorfobi.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-21-00.23.49.png' | relative_url }}"><img class="size-medium wp-image-536" alt="Statusrapport for testen." src="{{ '/assets/images/Screenshot-2014-02-21-00.23.49-750x328.png' | relative_url }}" width="750" height="328" /></a><figcaption>Statusrapport for testen.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-20.54.16.png' | relative_url }}"><img class="size-full wp-image-537" alt="Convert Experiments snupper omsætningen fra dit Google Analytics script - smart." src="{{ '/assets/images/Screenshot-2014-02-20-20.54.16.png' | relative_url }}" width="679" height="109" /></a><figcaption>Convert Experiments snupper omsætningen fra dit Google Analytics script - smart.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-23.03.19.png' | relative_url }}"><img class="size-medium wp-image-538" alt="Priserne hos Optimizely." src="{{ '/assets/images/Screenshot-2014-02-20-23.03.19-750x275.png' | relative_url }}" width="750" height="275" /></a><figcaption>Priserne hos Optimizely.</figcaption></figure>

<figure><a href="{{ '/assets/images/Screenshot-2014-02-20-23.03.36.png' | relative_url }}"><img class="size-full wp-image-539" alt="Priserne hos Visual Website Optimizer." src="{{ '/assets/images/Screenshot-2014-02-20-23.03.36.png' | relative_url }}" width="724" height="256" /></a><figcaption>Priserne hos Visual Website Optimizer.</figcaption></figure>
