...
<figure><a href="{{ '/assets/images/2019/09/Andel-nye-besgøende-pr.-ITP-version.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/09/Andel-nye-besgøende-pr.-ITP-version.jpg' | relative_url }}" alt="Andel nye besgøende pr. ITP-version" width="1170" height="652" class="size-full wp-image-1965" /></a><figcaption>Andel nye besgøende pr. ITP-version</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/10/Andel-nye-besgøende-pr.-ITP-version-og-device.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/10/Andel-nye-besgøende-pr.-ITP-version-og-device.jpg' | relative_url }}" alt="Andel nye besgøende pr. ITP-version og device" width="1106" height="568" class="size-full wp-image-1966" /></a><figcaption>Andel nye besgøende pr. ITP-version og device</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/10/Sessioner-pr.-bruger-fordelt-på-ITP-version-og-device.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/10/Sessioner-pr.-bruger-fordelt-på-ITP-version-og-device.jpg' | relative_url }}" alt="Sessioner pr. bruger fordelt på ITP-version og device" width="909" height="462" class="size-full wp-image-1970" /></a><figcaption>Sessioner pr. bruger fordelt på ITP-version og device</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/10/Browser-markedsandele-pr.-device.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/10/Browser-markedsandele-pr.-device.jpg' | relative_url }}" alt="Browser markedsandele pr. device" width="901" height="425" class="size-full wp-image-1971" /></a><figcaption>Browser markedsandele pr. device</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/11/Browser-markedsandele-pr.-device-jacobworsoe.dk_.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/11/Browser-markedsandele-pr.-device-jacobworsoe.dk_-860x441.jpg' | relative_url }}" alt="Browser markedsandele pr. device (jacobworsoe.dk)" width="860" height="441" class="size-large wp-image-2620" /></a><figcaption>Browser markedsandele pr. device (jacobworsoe.dk)</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/10/GA-cookie-bevares-mellem-7-dage-besøg.jpg' | relative_url }}"><img src="{{ '/assets/images/2019/10/GA-cookie-bevares-mellem-7-dage-besøg.jpg' | relative_url }}" alt="GA cookie bevares mellem besøg." width="1397" height="401" class="size-full wp-image-1973" /></a><figcaption>GA cookie bevares mellem besøg.</figcaption></figure>
...
<figure><a href="{{ '/assets/images/2019/10/ITP-iOS-safari-2-years-cookie-expiry.png' | relative_url }}"><img src="{{ '/assets/images/2019/10/ITP-iOS-safari-2-years-cookie-expiry.png' | relative_url }}" alt="_ga cookien levetid på hhv. Mac og iPhone." width="1144" height="747" class="size-full wp-image-1974" /></a><figcaption>_ga cookien levetid på hhv. Mac og iPhone.</figcaption></figure>
